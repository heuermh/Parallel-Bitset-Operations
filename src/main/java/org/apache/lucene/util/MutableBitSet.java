...
public class MutableBitSet extends AbstractBitSet implements Cloneable/*, Serializable */ {
   ...
   * @param numBits
   */
  public MutableBitSet(long numBits) {
   ...
   *
   */
  public MutableBitSet(long[] bits, int numWords) {
      this.bits = bits.clone();
    this.wlen = numWords;
    this.numBits = wlen * 64;
  }

    protected MutableBitSet(long[] bits, int numWords, boolean ignore) {
      this.bits = bits;
    this.wlen = numWords;
    this.numBits = wlen * 64;
  }
  ...
  */
  ...
  public long cardinality() {
    ...
    public UnsafeBitSet unsafeCopy() {
        return new UnsafeBitSet(bits.clone(), when);
    }

 /** Returns the popcount or cardinality of the intersection of the two sets.
   * Neither set is modified.
   */
  public static long intersectionCount(MutableBitSet a, MutableBitSet b) {
  ...
  /** Returns the popcount or cardinality of the union of the two sets.
    * Neither set is modified.
    */
  public static long unionCount(MutableBitSet a, MutableBitSet b) {
   ...
   * Neither set is modified.
   */
  public static long andNotCount(MutableBitSet a, MutableBitSet b) {
  ...
  * Neither set is modified.
  */
  public static long xorCount(MutableBitSet a, MutableBitSet b) {
  ...
  public Object clone() {
    try {
        MutableBitSet obs = (MutableBitSet)super.clone();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MutableBitSet)) return false;
    MutableBitSet a;
